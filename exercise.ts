...
const  double =(value:any) =>value*2;
...
// solution 5
var testResults = [3.89, 2.99, 1.38];
var [number1,number2,number3]=testResults;
console.log(number1);
...
let {firstName:name,experience}=scientist
